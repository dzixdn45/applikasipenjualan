...
<body>
  ...
  <div class="content">
      ...
      <?php
      $kd_plg = $_GET['kd_plg']; // assigment nik dengan nilai nik yang akan diedit
      $sql = mysqli_query($conn, "SELECT * FROM tb_pelanggan WHERE kd_plg='$kd_plg'"); // query untuk memilih entri data dengan nilai nik terpilih
      ...
      if(isset($_POST['save'])){ // jika tombol 'Save' dengan properti name="save" pada baris 135 ditekan
        ...
        $update = mysqli_query($conn, "UPDATE tb_pelanggan SET nama='$nama', alamat='$alamat', tlpn='$tlpn' WHERE kd_plg='$kd_plg'") or die(mysqli_error());
      ...
      <form class="form-horizontal" action="" method="POST">
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input type="text" name="kd_plg" value="<?php echo $rows['kd_plg']; ?>" class="form-control" placeholder="NIK" required>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="tlpn" value="<?php echo $rows['tlpn']; ?>" class="form-control" placeholder="Tempat Lahir" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-3 control-label">email</label>
          <div class="col-sm-3">
            <input type="text" name="email" value="<?php echo $rows['email']; ?>" class="form-control" placeholder="No Telepon" required>
          </div>
        </div>
        </div>
        <div class="form-group">
