...
<?php
$query = "SELECT max(kd_barang) as maxKode FROM tb_barang";
  ...
  <div id="wrapper" class="active">
    ...
    <div id="main-wrapper" class="col-md-11 pull-right">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <input type="text" name="kode_barang" class="form-control" value="<?php echo $newID; ?>">
          </div>
        </div>
    <div class="form-group">
         ...
         <div class="form-group">
          <label>satuan</label>
          <div class="form-group">
            <input type="textarea" name="satuan" class="form-control" placeholder="satuan" id="alamat">
          </div>
        </div>
         <div class="form-group">
          <label>qty</label>
          <div class="form-group">
            <input type="text" name="qty" class="form-control" placeholder="qty" id="email">
          </div>
        </div>
         <div class="form-group">
          <label>harga beli</label>
          <div class="form-group">
            <input type="text" name="beli" class="form-control" placeholder="Rp" id="tlp">
          </div>
        </div>
        <div class="form-group">
          <label>harga jual</label>
          <div class="form-group">
            <input type="text" name="jual" class="form-control" placeholder="Rp" id="tlp">
          </div>
        </div>
